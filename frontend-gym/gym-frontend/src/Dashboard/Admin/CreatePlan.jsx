    ...
    try {
      ...
      if (response.data.success) {
        const plan = {
          ...
          trainerType: response.data.plan.trainerType || newPlan.trainerType || "",
          trainerId: response.data.plan.trainerId || (newPlan.trainerId ? parseInt(newPlan.trainerId) : null),
        };
        const currentPlans =
          newPlan.type === "group"
            ? groupPlans
    ...
    try {
      ...
      if (response.data.success) {
        const updatedPlan = {
          ...
          trainerType: response.data.plan.trainerType || selectedPlan.trainerType || "",
          trainerId: response.data.plan.trainerId || selectedPlan.trainerId || null,
        };
