...
const InventoryManagement = () => {
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      const targetBranch = formData.branchId || branchId || user.branchId || (branches.length > 0 ? branches[0].id : "");
      const finalFormData = { ...formData };
      if (targetBranch) finalFormData.branchId = targetBranch;
      
      Object.entries(finalFormData).forEach(([k, v]) => fd.append(k, v));
